export const defaultMigrationOptions=Object.freeze({access:true,threat:true,https:true,nat:true,includeSections:true,objectSuffix:'',importTag:''});
export function normalizeMigrationOptions(value={}) {
  ...
  for(const key of ['access','threat','https','nat','includeSections'])if(typeof result[key]!=='boolean')throw new Error(`${key} must be true or false.`);
